        ...
        <div className='bg-white h-full p-6 rounded-3xl'>
            ...
            <form>
                ...
                <div className='flex justify-center mt-14'>
                    <button
                        className='font-medium h-10 w-40 bg-amber-400 border border-black hover:border-white flex items-center justify-center rounded-3xl flex-row gap-3 hover:text-white'>
                        <GiCheckMark/>
                        Save changes
                    </button>
                </div>
