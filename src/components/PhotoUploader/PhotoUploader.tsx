        ...
        <div className='flex flex-row gap-4 ml-[5%]'>
            <div className='mb-4 text-center'>
                {preview ? (
                    ...
                    <div
                        className='w-40 h-40 rounded-full bg-gray-100 flex items-center justify-center border-2 border-gray-300 text-sm text-gray-500'>
                        No Photo
                    </div>
                )}
            </div>
            <div className='flex flex-col gap-2 justify-center'>
                <label
                    className='h-1/4 w-1/2 border-2 border-gray-300 flex items-center justify-center rounded-full hover:cursor-pointer hover:border-gray-950'
                >
                    + Upload Photo
                    <input
                        type="file"
